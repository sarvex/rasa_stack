...
def add_model_param(parser: argparse.ArgumentParser, model_name: Text = "Rasa"
    ...
    defaults = {
        "type": str,
        "help": f"Path to a trained {model_name} model. If a directory is specified, it will use the latest model in this directory.",
    }
...
def add_stories_param(parser: argparse.ArgumentParser,
    ...
    parser.add_argument(
        ...
        help=f"File or folder containing {stories_name} stories.",
    )
